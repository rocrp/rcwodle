...
class CrossPointSettings {
 ...
 public:
  ...
  // WODLE-PORT: "73% · Title" banner on the sleep screen
  uint8_t sleepScreenProgress = 1;
  ...
  // WODLE-PORT: "N min left" reading-speed estimate next to the battery
  uint8_t statusBarTimeLeft = 1;
