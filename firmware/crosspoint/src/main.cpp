/* WODLE-PORT of upstream src/main.cpp (see vendor/VENDOR.md).
...
void enterDeepSleep(bool fromTimeout = false) {
  ...
  // WODLE-PORT: no WiFi teardown needed
...
void setup() {
  ...
  // WODLE-PORT: SD-firmware recovery handled by the vendor bootloader (tf_ota/HVR1)
...
void loop() {
  ...
  gpio.update();
  halTiltSensor.update();  // WODLE-PORT: no IMU
...
/* ---- RT-Thread entry (replaces the Arduino runtime) ---- WODLE-PORT ---- */
