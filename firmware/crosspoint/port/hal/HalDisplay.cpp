...
static const uint8_t LUT_GRAY4[245] = {
    ...
    0x00,0x00,0x00,0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    /* (1,1) -> white  [WODLE-PORT: group-2 black-push zeroed (was
     * 0x49,0x43,0x44 = ~16 frames driving white pixels through BLACK). The AA
     * pass runs AFTER the DU has already put clean white on the background, so
     * that black-push was pure black/white flash for no benefit. Group 3 still
     * does the white-recovery push, so white settles cleanly without the blink.
     * HIL knob: if the white background ghosts, restore 0x01,0x49,0x43,0x44. */
    0x01,0x08,0x02,0x08,0x03,0x01,0x01, 0x01,0x00,0x00,0x00,0x00,0x01,0x01,
