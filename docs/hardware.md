...
| I²C devices | **I²C1** (PA07/08): CST836U touch @0x15 (INT=PA42). **I²C2** (PA31/32, INT=PA30): AW32001 charger @0x49 (INT=PA41) + BQ27220 gauge @0x55 + **AHT20 temp/humidity @0x38** (user-confirmed populated; not on schematic sheet 1 — address is the part's fixed one). AW8155 amp = not I²C (GPIO enable PA11) | C-sch / C (AHT20) |
